...
export const useActionableVariantClass = (theme) => {
    switch (theme) {
        ...
        case 'primary':
        default:
            return 'text-center text-white bg-primary rounded-lg align-middle shadow-md shadow-tertiary [&>*]:align-middle hover:bg-tertiary active:shadow-inner active:shadow-darker-primary active:bg-dark-primary';
    }
}